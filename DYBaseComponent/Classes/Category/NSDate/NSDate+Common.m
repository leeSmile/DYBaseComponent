...
+ (NSDateFormatter *)newsDeatilDateFormatterWithFormatYYYYMMddHHmmInChinese
{
    ...
    if (!staticDateFormatterWithFormatYYYYMMddHHmmssInChines) {
        ...
        [staticDateFormatterWithFormatYYYYMMddHHmmssInChines setDateFormat:@"YYYY-MM-dd HH:mm"];
    }
...
+ (NSDateFormatter *)defaultDateFormatterWithFormatYYYYMMddInChinese
{
    ...
    if (!staticDateFormatterWithFormatMMddHHmmInChinese) {
        staticDateFormatterWithFormatMMddHHmmInChinese = [[NSDateFormatter alloc] init];
        [staticDateFormatterWithFormatMMddHHmmInChinese setDateFormat:@"YYYY年MM月dd日"];
    }
    
    return staticDateFormatterWithFormatMMddHHmmInChinese;
}

+ (NSDateFormatter *)dateFormatterWithFormatYYYYMMddHHmm {
...
- (NSString *)newsDetailStringOfDateWithFormatYYYYMMddHHmmInChinese
{
    return [[NSDate newsDeatilDateFormatterWithFormatYYYYMMddHHmmInChinese] stringFromDate:self];
}
